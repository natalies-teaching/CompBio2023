...
|Monday, February 6| Data Augmentation for Single Cell. Begin graph signal processing (GSP) background that we need for differential abundance anlaysis| [[SUGAR](https://papers.nips.cc/paper/2018/hash/c8ed21db4f678f3b13b9d5ee16489088-Abstract.html)], [[Graph Signal Processing Review Article](https://web.media.mit.edu/~xdong/paper/spm20.pdf)] |  | [[sugar](https://github.com/stanleyjs/sugar)] | 
|Wednesday, February 8| Finish graph signal processing background. Start differential abundance analysis with MELD| [[MELD](https://www.biorxiv.org/content/10.1101/532846v4)] |  | [[MELD](https://github.com/KrishnaswamyLab/MELD)] [[pyGSP](https://pygsp.readthedocs.io/en/stable/)] |
| Week 6-1 | Finish introducing graph signal processing, low-pass filtering, MELD for selecting condition-specific prototypical cells | [[The Emerging Field of Graph Signal Processing](https://arxiv.org/abs/1211.0053)] |  | |
